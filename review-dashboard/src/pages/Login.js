...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 font-mono">
      <img src="/github-bg.png" alt="Background" className="absolute inset-0 w-full h-full object-contain object-center opacity-5 pointer-events-none" />
      ...
      <div className="relative animate-scaleIn w-full max-w-md p-8 m-4 space-y-8 glass rounded-2xl shadow-2xl">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          {error && <p className="bg-red-900/50 text-red-300 border border-red-700/50 rounded-lg text-center p-3 text-sm">{error}</p>}
